...
/*
  ...
  */
function postReply(context, imageBuffer, author, username, mentions, tweetId) {
  return new Promise((resolve, reject) => {
    ...
    CLIENT.post(
      ...
      (err, media, response) => {
        ...
        // status: `Hey @${author} this image was mojified by @${username}
...
export async function index(context, req) {
  ...
  const { imageUrl, username, tweetId, author } = req.query;
